...
public class Database {
	...
	void initData() {
		...
		products.add(new Product("L’oreal DD Cream", 1, categories.get(2)));
		products.add(new Product("Avon CC Cream", 2, categories.get(2)));
		products.add(new Product("Revolution Powder Sunscreeen", 3, categories.get(2)));
		products.add(new Product("Maybelline BB Cream ", 4, categories.get(2)));
		products.add(new Product("Revlon Foundation+SPF20", 5, categories.get(2)));
		products.add(new Product("Nivea Matte Face SPF", 6, categories.get(2)));
		products.add(new Product("La Roche CC Cream", 7, categories.get(2)));
		products.add(new Product("Yves Rocher Powder+SPF15", 8, categories.get(2)));
		products.add(new Product("Nivea BB Cream", 9, categories.get(2)));
		products.add(new Product("Base O Boticário SPF20", 10, categories.get(2)));
		products.add(new Product("Natura SPF20 Rosto Matte", 11, categories.get(2)));
